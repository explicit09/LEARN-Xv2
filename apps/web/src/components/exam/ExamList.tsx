    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between glass-card p-4 rounded-2xl border border-border/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-bold text-foreground">Available Exams</p>
      ...
      <div className="space-y-3">
        {exams.map((exam) => (
          <button
            ...
            className="w-full flex items-center justify-between rounded-2xl border border-border/50 bg-card/40 backdrop-blur-sm p-4 hover:bg-card/80 hover:border-indigo-500/30 transition-all group shadow-sm text-left"
          >
            <div className="flex items-start gap-4 flex-1 min-w-0">
              ...
              <div className="min-w-0">
                <p className="font-bold text-foreground text-lg mb-0.5 truncate group-hover:text-indigo-500 transition-colors">
            ...
            <div className="shrink-0 w-8 h-8 rounded-lg bg-indigo-500/10 flex items-center justify-center text-indigo-500 opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all ml-4 border border-indigo-500/20">
