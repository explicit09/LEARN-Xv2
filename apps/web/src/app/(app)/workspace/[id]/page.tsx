            ...
            <div className="flex items-center gap-3 shrink-0">
              <div className="bg-card/50 backdrop-blur-md rounded-2xl p-4 border border-border/50 flex flex-col items-center min-w-[100px]">
                <span className="text-2xl font-black text-foreground">
                  {((workspace.total_token_count as number) / 1000).toFixed(0)}k
                </span>
                <span className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
                  Tokens
                </span>
              </div>
              <div className="bg-emerald-500/10 rounded-2xl p-4 border border-emerald-500/20 flex flex-col items-center min-w-[100px]">
